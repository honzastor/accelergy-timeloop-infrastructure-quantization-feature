...
PROBLEM="../prob/AlexNet/AlexNet_layer1.yaml"            # choices found in "inputs/prob"
...
timeloop-mapper ../arch/eyeriss_like.yaml ../arch/components/*.yaml ../constraints/*.yaml ../sparse_opt/*.yaml $MAPPER $PROBLEM -o ../outputs_live_status
